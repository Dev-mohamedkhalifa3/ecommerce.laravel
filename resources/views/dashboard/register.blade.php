				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
                        ...
                        @endif
                            ...
                            @endif
							<form class="form" method="post" action="{{ url('postregister') }}" >
								<!--begin::Title-->
                                ...
                                <div class="form-group">
									<div class="d-flex justify-content-between mt-n5">
										<label class="font-size-h6 font-weight-bolder text-dark pt-5">Repassword</label>
                                ...
                                <input type="submit" value="Register" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
                                </div>
                                @csrf
								<!--end::Form group-->
								<!--begin::Action-->
